...
-   The opportunity to lead a 2-hour workshop for event participants. The theme and 
    language of the workshop are at the discretion of the PARTNER. The number of 
    participants is set at 15. The number of workshops is set at 3. Workshops will 
    be allocated to the first PARTNERS to request them. A signed contract is required 
    to request a workshop. Requests must be sent to contact@pgday.fr before April 21, 2025, 
    at 23:59 CEST. The organizing committee reserves the right to refuse any workshop proposal that does not reflect the identity of PG DAY FRANCE.
...
**Cost for COMMUNITY EVENT SPONSOR opportunities, as described above, is 1500 €.**
...
-   The opportunity to lead a 2-hour workshop for event participants. The theme and 
    language of the workshop are at the discretion of the SUPPORTER. The number of 
    participants is set at 15. The number of workshops is set at 3. Workshops will 
    be allocated to the first PARTNERS to request them. If there are less than 3 PARTNERS
    requesting a workshop, the remaining workshops will be allocated to the firsts SUPPORTERS
    to request them. A signed contract is required to request a workshop. Requests 
    must be sent to contact@pgday.fr before April 21, 2025, at 23:59 CEST. 
    The organizing committee reserves the right to refuse any workshop proposal that 
    does not reflect the identity of PG DAY FRANCE.
